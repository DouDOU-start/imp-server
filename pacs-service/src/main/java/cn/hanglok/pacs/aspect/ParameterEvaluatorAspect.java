package cn.hanglok.pacs.aspect;

import cn.hanglok.pacs.exception.ResponseException;
import cn.hanglok.pacs.util.ConditionEvaluator;
...
public class ParameterEvaluatorAspect {
    ...
    @Before(value = "execution(* cn.hanglok.pacs.controller.ImpController.getSimpleSeriesList(String, Long[], String[], Double[], Long[], String, Long[], Long[], int, int)) && " +
