...
mainClass="cn.hanglok.algoSched.AlgoSchedApplication"
cp=/etc/imp/algorithm-scheduling/dependency/*:/etc/imp/algorithm-scheduling/algorithm-scheduling-server.jar
...
exec java -Xmx$PACS_MAX_MEMORY -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=/tmp -Djdk.tls.ephemeralDHKeySize=2048 $SPRING_CONFIG_PARAM -cp $cp $mainClass $@